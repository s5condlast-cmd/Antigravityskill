...
export function HeroCentered({
  badgeText = "v2.4 Engine: /debug, /design & /push",
  titleLead = "Precision engineering with",
  titleAccent = "deterministic quality.",
  subtitle = "An opinionated AI pair-programming skill that enforces zero-red-line type safety, mathematical design tokens, and atomic Git delivery.",
  primaryCtaText = "Get Started",
  primaryCtaHref = "#quickstart",
  commandSnippet = "git clone Antigravityskill",
  previewSlot,
}: HeroCenteredProps) {
  return (
