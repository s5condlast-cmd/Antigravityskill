...
export function HeroSplit({
  ...
  headlineLead = "Build modern applications with",
  headlineAccent = "unmatched velocity.",
  description = "High-density web applications with mathematical typography scales, fluid responsive grids, and accessible interactive primitives.",
    ...
    <section className="relative overflow-x-clip py-20 px-4 sm:px-6 lg:px-8 bg-zinc-950 text-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          {tagline && <span className="text-xs font-mono text-zinc-400 uppercase tracking-[0.12em]">{tagline}</span>}
